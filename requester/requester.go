...
type Work struct {
	...
	// DisableDumpBody is an option to prevent dump response body
	DisableDumpBody bool
...
// https://go.googlesource.com/proposal/+/refs/heads/master/design/43651-type-parameters.md#operations-permitted-for-any-type
