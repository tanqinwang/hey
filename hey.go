...
var (
	...
	disableDumpBody    = flag.Bool("disable-dump-body", false, "")
...
Options:
  -n  Number of requests to run. Default is 10.
  -c  Number of workers to run concurrently. Total number of requests cannot
      be smaller than the concurrency level. Default is 2.
  ...
  -U  User-Agent, defaults to version "hey/1.0.0".
  ...
  -disable-dump-body    Disable print response body
...
func main() {
	...
	w := &requester.Work{
		...
		DisableDumpBody:    *disableDumpBody,
		H2:                 *h2,
		ProxyAddr:          proxyURL,
		Output:             *output,
	}
